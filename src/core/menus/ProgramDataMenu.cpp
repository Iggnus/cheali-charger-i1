...
{string_Vc_per_cell,    ADV(LiXX_NiZn_Pb),  {CP_TYPE_V,0,&battery.Vc_per_cell},             {10,ANALOG_VOLT(0.0),ANALOG_VOLT(5.0)}},
{string_Vcutoff,        ADV(NiXX),          {CP_TYPE_V,0,&battery.Vc_per_cell},             {ANALOG_VOLT(0.01), ANALOG_VOLT(1.600), ANALOG_VOLT(1.850)}},
{string_Vd_per_cell,    ADV(BATTERY),       {CP_TYPE_V,0,&battery.Vd_per_cell},             {10,ANALOG_VOLT(0.0),ANALOG_VOLT(5.0)}},
...
{string_DCcycles,       COND_BATTERY,       {CP_TYPE_UNSIGNED,0,&battery.DCcycles},         {1, 0, 5}},
